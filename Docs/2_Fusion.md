...
**Note**: Many `QueryBuilder` & `Rune ORM` APIs default to running queries on `DB`. Be sure to register a singleton global database in your `Application.setup` to use them.
